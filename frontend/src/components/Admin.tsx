...
import { Save, X, Plus, Trash2, Home, Key, User, Eye, EyeOff, LogOut } from 'lucide-react';
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    readOnly
                    className="w-full px-4 py-2 border border-slate-300 dark:border-slate-700 rounded-lg bg-slate-100 dark:bg-slate-900 text-slate-500 dark:text-slate-400 cursor-not-allowed"
                  />
                  <p className="mt-1 text-xs text-slate-500 dark:text-slate-400">
                    Header role is managed in code for consistent display across all devices.
                  </p>
                </div>
                <div className="md:col-span-2">
                  ...
                  />
                  <p className="mt-1 text-xs text-slate-500 dark:text-slate-400">
                    Header tagline is managed in code for consistent display across all devices.
                  </p>
                </div>
                <div className="md:col-span-2">
                ...
                {certifications.map((cert, index) => (
                  <div key={cert.id} className="border border-slate-200 dark:border-slate-700 rounded-lg p-6">
                    ...
                    <div className="space-y-4">
                      ...
                      <div>
                        <label className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-2">Certificate Link</label>
                        <input
                          type="url"
                        ...
                        />
                        <p className="mt-1 text-xs text-slate-500 dark:text-slate-400">
                          Paste the public URL to your certificate or credential badge.
                        </p>
                      </div>
                      <div>
